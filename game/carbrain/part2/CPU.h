...
public:
    ...
    uint8_t fetchOperand1(std::shared_ptr<CPUInstruction::Operand> operand);
    spg_register_t fetchOperand2(std::shared_ptr<CPUInstruction::Operand> operand);
    void store1(const CPUInstruction::Instruction instr, uint8_t source);
    void store2(const CPUInstruction::Instruction instr, spg_register_t source);
    void store2source(const CPUInstruction::Instruction instr, spg_register_t source);
